@echo off
REM ============================================================
REM  Build and run the JRPC demo (console test runner)
REM
REM  Usage:
REM    BuildDemo.bat                 - build + run (Delphi 13 default)
...
cd /d "%~dp0Demo\JRPCDemo"
msbuild JRPCDemo.dproj /t:Make /p:config=Debug /p:platform=Win32
if %ERRORLEVEL% NEQ 0 (
  echo.
  echo =================================================
  echo ===       JRPCDemo Failed to Compile          ===
  echo =================================================
  exit /b 1
)

echo.
echo [RUN] JRPCDemo.exe
"..\Bin\JRPCDemo.exe"
exit /b %ERRORLEVEL%
